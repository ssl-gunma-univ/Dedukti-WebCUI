export const config = {
  ...
  webApiUrl: `http://localhost:80/webcui/dedukti/api/api.php`, //`http://solweb.mydns.jp/webcui/dedukti/api/api.php`,//
  ...
  features: {
    ...
    files: {
      ...
      text: 'Examples',
      webApiUrl: 'http://localhost:80/webcui/dedukti/api/files.php', //'http://solweb.mydns.jp/webcui/dedukti/api/files.php', //
    },
    variables: {
      enable: false,
